        ...
        <div class="card-body">
            <form action="" class="p-2" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-md-7 form-group">
                        <input type="text" class="form-control" name="tanggungan" placeholder="Tanggungan (Kalau Kawin)">
                    </div>
                    <div class="col-md-5">
                        <label>Awal Masa Kerja</label>
                    </div>
                    <div class="col-md-7 form-group">
                        <input type="date" class="form-control" name="awal_kerja" placeholder="Awal Masa Kerja">
                    </div>
                    <div class="col-md-5">
                        <label>Akhir Masa Kerja</label>
                    </div>
                    <div class="col-md-7 form-group">
                        <input type="date" class="form-control" name="akhir_kerja" placeholder="Akhir Masa Kerja">
                    </div>
                    <div class="col-md-5">
                        <label>Gaji</label>
                    </div>
