...
@section('main')
    <div class="card">
        <div class="card-body">
            <form action="{{ route('print.order', $data->id) }}" method="post">
                @csrf
                <div class="row">
                    <div class="col-md-5">
                    ...
                    <div class="col-md-5 form-group">
                        <input readonly type="text" class="form-control" value="{{ $customer->where('ktp', $data->ktp_penjual)->pluck('nama')->implode('[]', '"') }}" placeholder="Nama Penjual" aria-label="Nama Penjual" aria-describedby="button-addon">
                    </div>
                    ...
                    <div class="col-md-7 form-group">
                        <input required type="text" class="form-control" name="surat" placeholder="No. Surat">
                    </div>
                    <div class="col-md-5">
                        <label>Perihal Surat</label>
                    </div>
                    <div class="col-md-7 form-group">
                        <input required type="text" class="form-control" name="hal" placeholder="Perihal Surat">
                    </div>
                    <div class="col-md-5">
                        <label>Jenis Permohonan</label>
                    </div>
                    <div class="col-md-7 form-group">
                        <input readonly type="text" class="form-control" value="{{ $data->jenis_permohonan }}" name="jenis_permohonan" placeholder="Jenis Permohonan">
                    </div>
                    <div class="col-md-5">
                        <label>No. Permohonan</label>
                    </div>
                    <div class="col-md-7 form-group">
                        <input required type="text" class="form-control" name="nomor" placeholder="No. Permohonan">
                    </div>
                    <div class="col-md-5">
