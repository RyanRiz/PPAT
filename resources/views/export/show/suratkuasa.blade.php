...
@section('main')
    <div class="card">
        <div class="card-body">
            <form action="{{ route('print.kuasa', $data->id) }}" method="post">
                @csrf
                <div class="row">
                    <div class="col-md-5">
                    ...
                    <div class="col-md-7 form-group">
                        <input readonly type="date" class="form-control" name="ultah_penjual" value="{{ $customer->where('ktp', $data->ktp_penjual)->pluck('tanggal_lahir')->implode('[]', '"') }}">
                    </div>
                    <div class="col-md-5">
                    ...
                    <div class="col-md-7 form-group">
                        <input required type="text" class="form-control" name="keterangan" placeholder="Cont. Pembagian Hak Bersama">
                    </div>
